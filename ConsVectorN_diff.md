...
## Your proof attempt
Don't panic, your proof attempt for ConsVectorN_diff is not lost.<br>
...
```lisp
(induct "c")(typepred "c!1")(propax)(expand "length")(flatten)(grind)(skeep)(expand "length" -2)(postpone)
```